# Hi 👋🏻, I'm Syed Suhail Ahmed
### BSc (Hons) Computer Systems Graduate 🎓 | Junior IT Engineer @ PAN Home 💼 | Computer Vision & AI Enthusiast 🤖
...
- 🐙 GitHub: [github.com/Darth-Freljord](https://github.com/Darth-Freljord)
...
- Led a targeted **SEO strategy** that ranked the company's website in the **top 3** results for furniture-related searches.
- Leveraged **Magento** analytics to reform 75% of the product database to industry standards.
- Managed **Google Ads** campaigns, delivering insights that drove a **5% increase in website traffic** within 3 months.
...
Real-time PPE compliance system for construction and industrial environments. Achieved **85.1% mAP@50** at 30 FPS. Integrated voice alerts, mobile notifications, and a React-Flask web app for browser-based inference. Optimized with Mosaic augmentation, anchor box tuning, and learning rate scheduling — improving mAP@50 by **11%**.
...
Computer vision tool to detect medical masks in images with a real-time preprocessing pipeline. Achieved **90% detection accuracy** with a Tkinter GUI for single-image inference.
...
University collaboration platform featuring real-time chat, task assignment, and secure file sharing. Built 15+ UI components; improved user task flow by **40%** in usability tests. Supported **100+ test users** with stable Firebase syncing.
...
- 📰 **Published Research Paper** *(Indexed on Google Scholar)*
  [**Seeing Safety: Computer Vision for Real-Time PPE Monitoring in the Middle East Construction Sector**](https://ojs.aaai.org/index.php/AAAI-SS/article/view/36044)
  Presented at **AAAI 2025 Summer Symposium** — Context-Awareness in Cyber Physical Systems, Dubai, UAE

- 🏆 **Gargash UAE AI Hackathon** — **Top 25 Teams in the UAE**
